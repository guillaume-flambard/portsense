      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getRiskColor(container.risk_level || 'Low')}`}>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Generated by AI • Updated {container.last_updated ? formatDistanceToNow(new Date(container.last_updated)) + ' ago' : 'recently'}
              </p>
            </div>
          </div>
        )}
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
            ...
            <div>
              <strong>Last Updated:</strong> {container.last_updated ? formatDistanceToNow(new Date(container.last_updated)) + ' ago' : 'Unknown'}
            </div>
          </div>
        </div>
      </div>
