...
-- CreateTable
CREATE TABLE "public"."container_history" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
...
-- CreateIndex
CREATE INDEX "idx_container_history_container_id" ON "public"."container_history"("container_id");

-- CreateIndex
CREATE INDEX "idx_container_history_recorded_at" ON "public"."container_history"("recorded_at");

-- CreateIndex
CREATE UNIQUE INDEX "containers_container_id_key" ON "public"."containers"("container_id");

-- CreateIndex
CREATE INDEX "idx_containers_current_location" ON "public"."containers"("current_location");

-- CreateIndex
CREATE INDEX "idx_containers_destination_port" ON "public"."containers"("destination_port");

-- CreateIndex
CREATE INDEX "idx_containers_last_updated" ON "public"."containers"("last_updated");

-- CreateIndex
CREATE INDEX "idx_containers_origin_port" ON "public"."containers"("origin_port");

-- CreateIndex
CREATE INDEX "idx_containers_risk_level" ON "public"."containers"("risk_level");
...
-- AddForeignKey
ALTER TABLE "public"."alerts" ADD CONSTRAINT "alerts_container_id_fkey" FOREIGN KEY ("container_id") REFERENCES "public"."containers"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."alerts" ADD CONSTRAINT "alerts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."chat_messages" ADD CONSTRAINT "chat_messages_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."containers" ADD CONSTRAINT "containers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
